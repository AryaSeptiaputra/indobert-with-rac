"""Test RACClassifier: fusi probabilitas, distribusi retrieval, guard indeks, dan biaya FAISS."""
...
from src.services.rac import FaissBenchmark, NeighborCache, RACClassifier, l2_normalize, softmax
