...
`FaissBenchmark` mengukur biaya RAC yang tidak tampak sebagai waktu latih:
pembangunan indeks (sekali, dari embedding train) dan penelusuran (setiap
inferensi, tumbuh mengikuti k). Indeks bertipe flat/exact, jadi penelusuran
bersifat brute force atas seluruh 6.588 vektor. Untuk ukuran itu biayanya
sepele, dan hasilnya deterministik -- yang jauh lebih penting untuk penelitian
daripada penghematan waktu dari indeks aproksimasi.
"""
